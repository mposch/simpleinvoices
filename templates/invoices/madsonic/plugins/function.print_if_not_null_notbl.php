<?php
/**
* Function: print_if_not_null_notbl
* 
...
function smarty_function_print_if_not_null_notbl($params, &$smarty) {
        if ($params['field'] != null)
        {
                $print_if_not_null =  "
            <div class='".htmlsafe($params[class1])."'>".htmlsafe($params[label]).":</div><div class='".htmlsafe($params[class2])."'> ".htmlsafe($params[field])."</div>";
